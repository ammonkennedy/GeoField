...
export const FIELD_LABELS: Record<string, string> = {
  ...
  elevationAccuracy: "Elevation Accuracy (m)",
  horizon: "Horizon",
...
export const STRIKE_DIP_COLUMNS: ExportColumn[] = [
  ...
  { key: "measurementType", label: "Measurement Type", enabled: true, defaultWidth: 20 },
  { key: "azimuth", label: "Azimuth (°)", enabled: true, defaultWidth: 14 },
  { key: "plunge", label: "Plunge (°)", enabled: true, defaultWidth: 14 },
  ...
  { key: "elevation", label: "Elevation (m)", enabled: true, defaultWidth: 16 },
  { key: "elevationAccuracy", label: "Elevation Accuracy (m)", enabled: false, defaultWidth: 22 },
...
export function strikeDipToDataRow(
  ...
  return {
    ...
    measurementType: measurement.measurementType === "lineation" ? "Lineation" : "Strike & Dip",
    azimuth: measurement.measurementType === "lineation" ? measurement.trendDegrees ?? "" : "",
    plunge: measurement.measurementType === "lineation" ? measurement.plungeDegrees ?? "" : "",
    strike: measurement.measurementType === "lineation" ? "" : measurement.strike,
    dip: measurement.measurementType === "lineation" ? "" : measurement.dip,
    dipDir: measurement.measurementType === "lineation" ? "" : measurement.dipDir,
    ...
    elevationAccuracy: measurement.elevationAccuracy ?? "",
